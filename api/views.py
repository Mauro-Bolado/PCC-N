...
class Address_APIView_Detail(APIView):
    ...
    def delete(self, request, pk, format=None):
        address = self.get_queryset(pk)
        address.delete()
        return JsonResponse({'detail': 'Address deleted'}, status=status.HTTP_200_OK, safe=False)
...
class DeclarationDate_APIView_Detail(APIView):
    ...
    def delete(self, request, pk, format=None):
        ...
        return JsonResponse({'detail': 'Declaration date deleted'}, status=status.HTTP_200_OK, safe=False)
...
class PaymentDate_APIView_Detail(APIView):
    ...
    def delete(self, request, pk, format=None):
        ...
        core.delete()
        return HttpResponse({'detail': 'Payment date deleted'}, status=status.HTTP_204_NO_CONTENT, safe=False)
...
class Core_APIView_Detail(APIView):
    ...
    def delete(self, request, pk, format=None):
        core = get_object_or_404(Core, pk=pk)
        core.delete()
        return HttpResponse({'detail': 'Core deleted'}, status=status.HTTP_204_NO_CONTENT, safe=False)
...
class Militant_APIView_Detail(APIView):
    ...
    def delete(self, request, pk, format=None):
        militant = self.get_queryset(pk)
        militant.delete()
        return HttpResponse({'detail': 'Militant deleted'}, status=status.HTTP_400_BAD_REQUEST, safe=False)
